...
export const CONSTELLATION_DIAGRAMS: Record<string, ConstellationDiagramData> = {
  ...
  'sagittarius': {
    viewBox: '0 0 340 280',
    stars: [
      { id: 'kaus_borealis', x: 170, y: 40, mag: 3, canonicalName: 'astrology.fixed-star.kaus-borealis', label: 'Kaus Borealis' },
      { id: 'kaus_media', x: 110, y: 110, mag: 3, canonicalName: 'astrology.fixed-star.kaus-media', label: 'Kaus Media' },
      { id: 'kaus_australis', x: 210, y: 120, mag: 1, canonicalName: 'astrology.fixed-star.kaus-australis', label: 'Kaus Australis' },
      { id: 'alnasl', x: 250, y: 190, mag: 3, canonicalName: 'astrology.fixed-star.alnasl', label: 'Alnasl' },
      { id: 'nunki', x: 70, y: 160, mag: 2, canonicalName: 'astrology.fixed-star.nunki', label: 'Nunki' },
      { id: 'ascella', x: 90, y: 220, mag: 3, canonicalName: 'astrology.fixed-star.ascella', label: 'Ascella' },
    ],
    lines: [
      ['kaus_borealis', 'kaus_media'],
      ['kaus_borealis', 'kaus_australis'],
      ['kaus_media', 'kaus_australis'],
      ['kaus_australis', 'alnasl'],
      ['kaus_media', 'nunki'],
      ['nunki', 'ascella'],
      ['ascella', 'kaus_media'],
    ],
  ...
  'pisces': {
    viewBox: '0 0 360 300',
    stars: [
      { id: 'alrescha', x: 180, y: 200, mag: 2, canonicalName: 'astrology.fixed-star.alrescha', label: 'Alrescha' },
      { id: 'cord_ne1', x: 210, y: 150, mag: 5 },
      { id: 'cord_ne2', x: 230, y: 100, mag: 5 },
      { id: 'eta_piscium', x: 250, y: 60, mag: 3, canonicalName: 'astrology.fixed-star.eta-piscium', label: 'Eta Piscium' },
      { id: 'omega_piscium', x: 290, y: 80, mag: 4, canonicalName: 'astrology.fixed-star.omega-piscium', label: 'Omega Piscium' },
      { id: 'circlet_a', x: 280, y: 30, mag: 5 },
      { id: 'cord_sw1', x: 140, y: 240, mag: 5 },
      { id: 'cord_sw2', x: 90, y: 260, mag: 5 },
      { id: 'fish_w1', x: 50, y: 230, mag: 5 },
      { id: 'fish_w2', x: 40, y: 180, mag: 5 },
      { id: 'fish_w3', x: 80, y: 160, mag: 5 },
    ],
    lines: [
      ['alrescha', 'cord_ne1'],
      ['cord_ne1', 'cord_ne2'],
      ['cord_ne2', 'eta_piscium'],
      ['eta_piscium', 'omega_piscium'],
      ['omega_piscium', 'circlet_a'],
      ['circlet_a', 'eta_piscium'],
      ['alrescha', 'cord_sw1'],
      ['cord_sw1', 'cord_sw2'],
      ['cord_sw2', 'fish_w1'],
      ['fish_w1', 'fish_w2'],
