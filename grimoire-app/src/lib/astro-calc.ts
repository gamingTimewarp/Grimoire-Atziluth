...
const MOON_PHASE_ENTRIES: Array<{ max: number; name: MoonPhaseName; emoji: string; isMajor: boolean }> = [
  { max: 0.0625, name: 'New Moon',        emoji: '🌑', isMajor: true  },
  { max: 0.25,   name: 'Waxing Crescent', emoji: '🌒', isMajor: false },
  { max: 0.3125, name: 'First Quarter',   emoji: '🌓', isMajor: true  },
  { max: 0.5,    name: 'Waxing Gibbous',  emoji: '🌔', isMajor: false },
  { max: 0.5625, name: 'Full Moon',       emoji: '🌕', isMajor: true  },
  { max: 0.75,   name: 'Waning Gibbous',  emoji: '🌖', isMajor: false },
  { max: 0.8125, name: 'Last Quarter',    emoji: '🌗', isMajor: true  },
  { max: 1.0,    name: 'Waning Crescent', emoji: '🌘', isMajor: false },
]
...
export function getMoonPhase(date: Date): MoonPhaseInfo {
  ...
  return { phase, name: entry.name, emoji: entry.emoji, illumination, isMajor: entry.isMajor }
}
